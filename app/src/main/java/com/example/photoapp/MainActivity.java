...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_load.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent load = new Intent(Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
                startActivityForResult(load, SELECT_A_PHOTO);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            //Bitmap takeImage = BitmapFactory.decodeFile(currentPhotoPath);
            Glide.with(this).load(currentPhotoPath).into(iv_photo);
            //iv_photo.setImageBitmap(takeImage);
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                ...
                Toast.makeText(this, "Something went wrong, file not created", Toast.LENGTH_SHORT).show();
            }
